...
struct FloatType
{
    ...
    FloatType& operator+=(float number);
    FloatType& operator-=(float number);
    FloatType& operator*=(float number);
    FloatType& operator/=(float number);
...
struct DoubleType
{
    ...
    DoubleType& operator+=(double number);
    DoubleType& operator-=(double number);
    DoubleType& operator*=(double number);
    DoubleType& operator/=(double number);
...
FloatType& FloatType::operator+=(float number)
{
    *value += number;
    return *this;
}
...
DoubleType& DoubleType::operator+=(double number)
{
    *value += number;
    return *this;
}
...
IntType& IntType::operator+=(int number)
{
    *value += number;
    return *this;
}
