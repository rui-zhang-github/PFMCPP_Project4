...
struct FloatType
{
    FloatType(float number) : value(new float(number)) {}
...
struct DoubleType
{
    DoubleType(double number) : value(new double(number)) {}
...
struct IntType
{
    IntType(int number) : value(new int(number)) {}
...
FloatType& FloatType::subtract(const FloatType& it) { return subtract(*it.value); }
...
FloatType& FloatType::multiply(const FloatType& it) { return multiply(*it.value); }
...
FloatType& FloatType::divide(const FloatType& it) { return divide(*it.value); }
...
// The function above can also be written as below, but don't repeat yourself!
